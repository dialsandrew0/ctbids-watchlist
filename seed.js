...
async function seedDatabase() {
  ...
  try {
    ...
    const items = [
      ...
      {
        auction_id: auction.id,
        title: 'Vintage Teak Sideboard',
        description: 'Danish modern teak wood sideboard with original handles',
        url: 'https://www.ctbids.com/estate-auctions/lot/125',
    ...
    console.log(`   - ${auctionItems.length} items`);
    console.log('\n💡 Next: Log in to the app and add these items to your watchlist');
  } catch (error) {
